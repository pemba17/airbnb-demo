    ...
    return (
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10 gap-4">
            ...
            <div className="flex items-center border-2 rounded-full py-2 md:shadow-sm">
                <input type="text" placeholder={placeholder|| 'Search'} className="bg-transparent outline-none flex-grow text-sm text-gray-600 placeholder-gray-400 px-4 " value={searchInput} onChange={(e)=>setSearchInput(e.target.value)}/>
            ...
            {searchInput && (
                <div className="flex flex-col col-span-3 mx-auto">
                    ...
                    <div className="flex items-center border-b mb-4">
                        ...
                        <input type="number" className="w-12 pl-2 text-lg text-red-400 outline-none" value={noOfGuests} onChange={(e)=>setNoOfGuests(e.target.value)} min={1}/>
                    </div>
